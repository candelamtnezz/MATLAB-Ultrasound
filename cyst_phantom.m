...
% ten point targets separated by 5 mm and a 10 mm water filled cyst.
...
amp = amp .* (1-inside);
% Second cyst
r2 = 5/1000;        % Radius of second cyst [m]
xc2 = 10/1000;      % Shifted to the right [m]
zc2 = 45/1000 + z_start;  % Deeper than first cyst [m]
inside2 = ( ((x-xc2).^2 + (z-zc2).^2) < r2^2);
amp = amp .* (1-inside2);
